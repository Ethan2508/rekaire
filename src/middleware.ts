...
export function middleware(request: NextRequest) {
  ...
  response.headers.set(
    ...
    [
      ...
      "font-src 'self'",
      "connect-src 'self' https://api.stripe.com https://*.sanity.io https://*.supabase.co https://api-adresse.data.gouv.fr https://challenges.cloudflare.com https://www.google-analytics.com https://region1.google-analytics.com https://www.google.com https://www.googletagmanager.com https://googleads.g.doubleclick.net https://*.google.com https://*.sentry.io https://*.ingest.de.sentry.io",
