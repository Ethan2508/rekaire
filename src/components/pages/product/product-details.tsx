...
const features = [
  {
    ...
    description: "Le RK01 se déclenche automatiquement lorsque la température atteint 90°C. Aucune intervention humaine nécessaire, aucune source d'énergie requise.",
  },
  {
    icon: Droplets,
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4 p-4 bg-white rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Activation automatique à 90°C</p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 bg-white rounded-lg">
