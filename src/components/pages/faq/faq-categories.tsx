    ...
    faqs: [
      {
        ...
        answer: "Le RK01 est un système autonome d'extinction incendie conçu spécifiquement pour les tableaux électriques. Il se déclenche automatiquement en cas de surchauffe (170°C) et éteint les départs de feu sans intervention humaine."
      },
      {
